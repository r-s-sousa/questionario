...
$this->insert('modelos/base', [
   ...
   <br>
   <label class="ml-3"><input type="radio" required name="q13" class="radio" value="Pesquisa clínica – envolvem pacientes humanos com o objetivo de melhorar o diagnóstico e tratamento de doenças ou agravos."> Pesquisa clínica – envolvem pacientes humanos com o objetivo de melhorar o diagnóstico e tratamento de doenças ou agravos.</label>
   <br>
   <label class="ml-3"><input type="radio" required name="q13" class="radio" value="Pesquisa sobre serviços de saúde – tem como objetivo avaliar os sistema ou serviços de saúde em relação à organização, financiamento, acesso e custos da atenção à saúde."> Pesquisa sobre serviços de saúde – tem como objetivo avaliar os sistema ou serviços de saúde em relação à organização, financiamento, acesso e custos da atenção à saúde.</label>
   <br>
   <label class="ml-3"><input type="radio" required name="q13" class="radio" value="Pesquisa sobre população e saúde pública – investigam os determinantes de saúde de uma determinada população, com o intuito de propiciar melhoria da qualidade da saúde."> Pesquisa sobre população e saúde pública – investigam os determinantes de saúde de uma determinada população, com o intuito de propiciar melhoria da qualidade da saúde.</label>
   '
]);
